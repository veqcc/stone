...
public class Parser {
    protected static abstract class Element {
        protected abstract void parse(Lexer lexer, List<ASTree> res) throws Exception;

        protected abstract boolean match(Lexer lexer) throws Exception;
    }
    ...
    protected static class Tree extends Element {
        ...
        protected boolean match(Lexer lexer) throws Exception {
    ...
    protected static class OrTree extends Element {
        ...
        protected Parser choose(Lexer lexer) throws Exception {
    ...
    protected static class Expr extends Element {
        ...
        public void parse(Lexer lexer, List<ASTree> res) throws Exception {
        ...
        private Precedence nextOperator(Lexer lexer) throws Exception {
            Token t = lexer.peek(0);
            if (t.isIdentifier())
